...
\title{{\fontsize{25}{24}\sffamily\textbf{Sustainable dinner recipes}}
	\author{
	\large\textbf{Aslaug Angelsen}\vspace{4em}\\
		%\includegraphics[width=74mm]{{../images/emblem.png}}\vspace{4em}\\
		Master in Clinical Nutrition\\ at the University of Bergen}
